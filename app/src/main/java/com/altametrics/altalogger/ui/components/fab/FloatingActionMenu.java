package com.altametrics.altalogger.ui.components.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mLabelsTextSize = attr.getDimension(R.styleable.FloatingActionMenu_menu_labels_textSize, getResources().getDimension(R.dimen.twelveDip));
        ...
        if (mIcon == null) {
            mIcon = LogUIUtl.getDrawable(R.drawable.icon_plus);
        }
    ...
    public OnClickListener getOnMenuButtonClickListener() {
        return mMenuButton.getOnClickListener();
    }
